...
if __name__=="__main__":
	"""
	Runs the GARMIN plotter for all indoor .tcx files (make sure you have only indoor files in the directory where you run this)
	>python plotgarmintcx_indoor_all.py
	"""
	...
	for file in filelist:
		print file
		os.system('python plotgarmintcx_indoor.py %s' %(file))
